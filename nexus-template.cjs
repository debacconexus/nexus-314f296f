...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Academic Progress Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "student";
process.env.TABLE_NAME = process.env.TABLE_NAME || "student_records";
'use strict';
